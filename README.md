📊 Swiggy Funnel Conversion & Traffic Analysis
🔍 Project Overview
...
Evaluated whether order movement was proportional to traffic changes.

2. Funnel Conversion Analysis

Measured overall conversion % and stage-level volatility.

3. Stage Sensitivity Assessment

Identified which funnel stage contributes most to performance instability.
